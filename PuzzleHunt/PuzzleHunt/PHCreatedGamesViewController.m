...
- (NSMutableArray *)createdGames
{
    if (!_createdGames) {
        ...
        NSArray *fakeGameDescriptions = [[NSArray alloc] initWithObjects:@"For Jenny's birthday!",@"Avast, ye mateys! Ready your ships to find the loot!",@"Built for a rainy day. Built to last.",@"The one. The only. The original game!",@"Why did the bard never smile? Find out with these brand-new clues!",@"To grandmother's house we go...",@"Blast-off in three...two...one...GO!",@"Palantir's Yearly Puzzle Hunt",@"A whodunit with a modern twist.",nil];
